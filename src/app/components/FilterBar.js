    ...
    return (
        <div className="bg-white p-6 rounded-xl shadow-md mb-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                    ...
                    >
                        ...
                        {availableMonths.map((month) => (
                            <option key={month} value={month}>
                                {new Date(`2023-${month}-01`).toLocaleDateString("id-ID", {
                                    month: "long",
                                })}
                            </option>
                        ))}
                ...
                {/* Kabupaten */}
                <div>
                    <label htmlFor="filter-kabupaten" className="block text-sm font-medium text-gray-700 mb-1">
                        Kabupaten
                    </label>
                    <select
                        id="filter-kabupaten"
                ...
                {/* Petugas */}
                <div className="lg:col-span-2">
                    <label htmlFor="filter-petugas" className="block text-sm font-medium text-gray-700 mb-1">
                        Petugas
                    </label>
                    <select
                        id="filter-petugas"
